...
export const translations = {
  pt: {
    ...
    downloadReport: 'Relatório Oficial RBMC (PDF)',
    year: 'Ano',
    day: 'Dia',
    hour: 'Hora',
    minute: 'Minuto',
    type: 'Tipo',
    rinex2Daily: 'RINEX2 diário (15s)',
    rinex3Daily: 'RINEX3 diário (15s)',
    rinex31s: 'RINEX3 (1s)',
    orbitas: 'Órbitas multiconstelação',
    stationCodeUsed: 'Sigla usada na API',
    downloading: 'Baixando...',
    reportsAndRinex: 'Relatórios & RINEX',
    downloadsFor: 'Downloads da estação',
    officialReport: 'Relatório Oficial',
    rinexData: 'Dados RINEX',
    downloadPdf: 'Baixar PDF oficial',
    rinexAvailabilityHint: 'RINEX costuma ficar disponível com atraso de 24-48h. Se falhar, tente D-2, D-3 ou D-7.',
    showOnMap: 'Ver no mapa',
    checkingAvailability: 'Verificando disponibilidade...',
    noFilesForDate: 'Nenhum arquivo disponível para essa data/parâmetros.',
    ...
    pagination: 'Paginação da lista de estações',
    previous: 'Anterior',
    next: 'Próxima',
    page: 'Página',
    of: 'de',
  ...
  en: {
    ...
    downloadReport: 'Official RBMC Report (PDF)',
    year: 'Year',
    day: 'Day',
    hour: 'Hour',
    minute: 'Minute',
    type: 'Type',
    rinex2Daily: 'RINEX2 daily (15s)',
    rinex3Daily: 'RINEX3 daily (15s)',
    rinex31s: 'RINEX3 (1s)',
    orbitas: 'Multiconstellation orbits',
    stationCodeUsed: 'API station code',
    downloading: 'Downloading...',
    reportsAndRinex: 'Reports & RINEX',
    downloadsFor: 'Downloads for station',
    officialReport: 'Official Report',
    rinexData: 'RINEX Data',
    downloadPdf: 'Download official PDF',
    rinexAvailabilityHint: 'RINEX data is usually available with a 24-48h delay. If it fails, try D-2, D-3 or D-7.',
    showOnMap: 'Show on map',
    checkingAvailability: 'Checking availability...',
    noFilesForDate: 'No files available for this date/parameters.',
    ...
    pagination: 'Station list pagination',
    previous: 'Previous',
    next: 'Next',
    page: 'Page',
    of: 'of',
